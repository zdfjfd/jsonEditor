...
from qfluentwidgets import (FluentWindow, setTheme, Theme, StateToolTip,
                            InfoBar, InfoBarPosition, NavigationItemPosition)
from qfluentwidgets import FluentIcon as FIF
import sys
import ctypes
from pathlib import Path
from EditorWidgets import (EditInterface, DragDropWindow,
                           DialogInterface, SettingsInterface)
...
class Window(FluentWindow):
    ...
    def __init__(self):
        ...
        self.homeInterface = DragDropWindow(
            'Home Interface',
            parent_dir + '/UI/Home.ui',
            self
        )
    ...
    def auto_save(self):
        """自动保存"""
        if (isinstance(self.active_interface, DragDropWindow)
                or self.file is not self.active_interface.file):
...
if __name__ == '__main__':
    ...
    font_id = font_db.addApplicationFont(parent_dir +
